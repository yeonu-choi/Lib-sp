...
/**
 * Servlet implementation class BookReturnListServlet
 */
@WebServlet("/admin/rblist")
public class BookReturnListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BookReturnListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ReturnBook> list = rbService.selectList(pi);
